...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private com.example.lenovo.fang_qq_login.SQL.MySql mySql;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        mySql = new com.example.lenovo.fang_qq_login.SQL.MySql(getApplicationContext());
...
//        Uri.parse("android.resource://" + getPackageName() + "/" +
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.login:
                Intent in = new Intent(com.example.lenovo.fang_qq_login.MainActivity.this, com.example.lenovo.fang_qq_login.HomeActivity.class);
                if (zhuce != null) {
            ...
            public void afterEvent(int event, int result, Object data) {
                ...
                if (result == SMSSDK.RESULT_COMPLETE) {
                    ...
                    if (cursorPhone.getCount() != 0) {
                        Toast.makeText(com.example.lenovo.fang_qq_login.MainActivity.this, "手机号已注册,请直接登陆", Toast.LENGTH_SHORT).show();
                    } else {
                        Intent intent = new Intent(com.example.lenovo.fang_qq_login.MainActivity.this, com.example.lenovo.fang_qq_login.zhuceActivity.class);
